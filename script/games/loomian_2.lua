...
local DiscordInvite = "https://discord.gg/axiomhub"
...
otherPage.Button({
    ...
    Callback = function()
        loadstring(game:HttpGet(
            "https://raw.githubusercontent.com/thedragonslayer2/hey/main/Misc./Find%20the%20most%20empty%20server%20script"))()
    end
})
